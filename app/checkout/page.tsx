...
export default function Checkout() {
	...
	const [confirmedOrder, setConfirmedOrder] = useState<CofirmedOrder | null>(
		null
	);
			...
			<div className="max-sm:w-[327px] sm:max-md:w-[90%] md:max-[1200px]:w-[689px] min-[1200px]:max-[1439px]:w-[1110px] min-[1440px]:w-[1440px] mx-auto text-black">
				...
				<div className=" grid min-[1200px]:grid-cols-[2fr_1fr] gap-8">
					<div className="bg-white rounded-lg p-6 sm:p-12">
						<h1 className="font-bold text-[28px] sm:text-[32px] uppercase mb-8">
							Checkout
						</h1>
							...
							<div className="mb-8">
								...
								<div className="grid sm:grid-cols-2 gap-4">
									<div className="relative">
										...
										{errors.name && (
											<span className="absolute top-0 right-0 text-[12px] text-red-500">
												{errors.name}
											</span>
										)}
										<input
						...
						{cartItems.length === 0 ? (
							...
							<>
								...
								<div className="space-y-2 mb-6">
									...
									<div className="flex justify-between">
										<p className="text-black/50 uppercase text-[15px]">
											Shipping
										</p>
