    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={centerAlign}>
          ...
          <Text style={orderIdStyle}>Order ID: <strong>#{orderId}</strong></Text>
          <Text style={thankYouTextStyle}>
            Hi {customerName}, your order has been confirmed and will be shipped soon.
          </Text>
        </Section>
          ...
          {items.map((item, index) => (
            <Row key={index} style={itemRow}>
              ...
              <Column style={itemDetails}>
                ...
                <Text style={itemPriceStyle}>$ {item.price.toLocaleString()}</Text>
              </Column>
        ...
        <Section style={totalsSection}>
          <Row style={totalRow}>
            ...
            <Column width={100}>
              <Text style={totalValueStyle}>$ {totals.subtotal.toLocaleString()}</Text>
            </Column>
          </Row>
          <Row style={totalRow}>
            <Column>
            ...
            <Column width={100}>
              <Text style={totalValueStyle}>$ {totals.shipping.toLocaleString()}</Text>
            </Column>
          </Row>
          <Row style={totalRow}>
            <Column>
            ...
            <Column width={100}>
              <Text style={totalValueStyle}>$ {totals.vat.toLocaleString()}</Text>
            </Column>
          </Row>
          <Row style={grandTotalRow}>
            ...
            <Column width={100}>
              <Text style={grandTotalValueStyle}>$ {totals.grandTotal.toLocaleString()}</Text>
            </Column>
          </Row>
        </Section>
        ...
        <Section style={section}>
          ...
          <Section style={shippingInfo}>
            ...
            <Text style={shippingTextStyle}>{shipping.city}, {shipping.zipCode}</Text>
        ...
        <Section style={footer}>
          <Text style={footerTextStyle}>Thank you for shopping with Audiophile!</Text>
